...
class Task(models.Model):
    ...
    estimated_time = models.PositiveIntegerField(
        null=True,
        blank=True,
        help_text="Оценка времени в часах"
    )
    actual_time = models.PositiveIntegerField(
        null=True,
        blank=True,
        help_text="Фактически затраченное время в часах"
    )
...
class TaskLog(models.Model):
    ...
    changes = models.JSONField(null=True, blank=True)  # Детали изменений

    # Для связи с другими объектами (комментарии, вложения и т.д.)
